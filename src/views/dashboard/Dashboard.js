                ...
                <CCol xs="12" md="6" xl="6">
                  ...
                  <div className="progress-group mb-4">
                    ...
                    <div className="progress-group-bars">
                      <CProgress className="progress-xs" color="info" value="50" />
                      <CProgress className="progress-xs" color="danger" value="70" />
                    </div>
                  </div>
                  <div className="progress-group mb-4">
                    <div className="progress-group-prepend">
                    ...
                    <div className="progress-group-bars">
                      ...
                      <CProgress className="progress-xs" color="danger" value="90" />
                    </div>
                  </div>
                  <div className="progress-group mb-4">
                    <div className="progress-group-prepend">
                    ...
                    <div className="progress-group-bars">
                      ...
                      <CProgress className="progress-xs" color="danger" value="40" />
                    </div>
                  </div>
                  <div className="progress-group mb-4">
                    <div className="progress-group-prepend">
                  ...
                  <div className="progress-group mb-4">
                    ...
                    <div className="progress-group-bars">
                      <CProgress className="progress-xs" color="info" value="25" />
                      <CProgress className="progress-xs" color="danger" value="30" />
                    </div>
                  </div>
                  <div className="progress-group mb-4">
                    <div className="progress-group-prepend">
                    ...
                    <div className="progress-group-bars">
                      <CProgress className="progress-xs" color="info" value="37" />
                      <CProgress className="progress-xs" color="danger" value="8" />
                    </div>
                  </div>
                  <div className="progress-group mb-4">
                    <div className="progress-group-prepend">
                    ...
                    <div className="progress-group-bars">
                      <CProgress className="progress-xs" color="info" value="30" />
                      <CProgress className="progress-xs" color="danger" value="80" />
                    </div>
                  </div>
                  ...
                  <CRow>
                    <CCol sm="6">
                      <CCallout color="warning">
                        ...
                        <br />
                        <strong className="h4">623</strong>
                      </CCallout>
                    </CCol>
                    <CCol sm="6">
                      <CCallout color="success">
                        ...
                        <br />
                        <strong className="h4">10000</strong>
                      </CCallout>
                    </CCol>
                  </CRow>
